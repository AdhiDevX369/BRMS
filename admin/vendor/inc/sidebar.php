<ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          <h6 class="dropdown-header">who need to register</h6>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          <h6 class="dropdown-header">Add a Business:</h6>
          <a class="dropdown-item" href="admin-add-business.php">Add</a>
          <a class="dropdown-item" href="admin-view-business.php">View</a>
          <a class="dropdown-item" href="admin-manage-business.php">Manage</a>
        </div>
      </li>
